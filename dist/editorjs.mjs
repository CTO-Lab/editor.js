...
let Mt = (s = 21) => crypto.getRandomValues(new Uint8Array(s)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
...
const S = be.bind(window, !1), K = be.bind(window, !0);
function te(s) {
...
function Xt(s, e) {
  ...
  return D(t) ? t(s) : J(t) ? s[t] : (t !== void 0 && S("Conversion «export» property must be a string or function. String means key of saved data object to export. Function should export processed string to export."), "");
}
function Vt(s, e) {
...
class F extends we {
  ...
  async getActiveToolboxEntry() {
    ...
    return e.find((i) => Object.entries(i.data).some(([n, r]) => t[n] && jt(t[n], r)));
  }
  /**
    ...
    return [...this.tunesInstances.values(), ...this.defaultTunesInstances.values()].forEach((n) => {
      if (D(n.wrap))
        try {
          ...
          S(`Tune ${n.constructor.name} wrap method throws an Error %o`, "warn", r);
        }
    }), e.appendChild(i), e;
  }
  /**
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (t) => {
      const { mutations: o } = t;
      o.some((n) => Kt(n, this.toolRenderedElement)) && this.didMutated(o);
      ...
      function x(b, g) {
        ...
        if (g.singleton) {
          ...
          b.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (E = function(L) {
            ...
            var Q = ce.css, Ee = ce.sourceMap, St = W.convertToAbsoluteUrls === void 0 && Ee;
            (W.convertToAbsoluteUrls || St) && (Q = k(Q)), Ee && (Q += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(Ee)))) + " */");
            var Ct = new Blob([Q], { type: "text/css" }), Ve = L.href;
            L.href = URL.createObjectURL(Ct), Ve && URL.revokeObjectURL(Ve);
...
var Oo = Object.defineProperty, Ao = Object.getOwnPropertyDescriptor, No = (s, e, t, o) => {
...
const z = class extends we {
   ...
   */
  constructor(s) {
    super(), this.scopeElement = document.body, this.listeners = new De(), this.scrollLocker = new ft(), this.nodes = {
      wrapper: null,
      popover: null,
...
const bt = class extends we {
  ...
  make() {
    ...
    }), this.popover.on(ge.Close, this.onPopoverClose), this.enableShortcuts(), this.nodes.toolbox = this.popover.getElement(), this.nodes.toolbox.classList.add(bt.CSS.toolbox), this.nodes.toolbox;
  }
  /**
...
const et = "block-removed", tt = "block-added", Wo = "block-moved", Yo = "block-changed";
class Ko extends C {
  constructor() {
...
const xt = class extends C {
   ...
   */
  async processFile(s) {
    const e = At(s), t = Object.entries(this.toolsFiles).find(([n, { mimeTypes: r, extensions: a }]) => {
...
class Ke {
  ...
  checkState() {
    ...
    if (e) {
      this.nodes.button.innerHTML = _o, this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
...
class Tt extends C {
   ...
   */
  async prepare() {
    if (this.validateTools(), this.config.tools = Ce({}, this.internalTools, this.config.tools), !Object.prototype.hasOwnProperty.call(this.config, "tools") || Object.keys(this.config.tools).length === 0)
...
class hi extends C {
  constructor() {
    super(...arguments), this.isMobile = !1, this.contentRectCache = void 0, this.resizeDebouncer = Rt(() => {
      this.windowResize();
    }, 200);
  }
  /**
  ...
  redactorClicked(e) {
    ...
    if (d.isAnchor(i) && n) {
      o();
      const u = i.getAttribute("href"), h = Pt(u);
      Ht(h);
      return;
    }
...
class pi {
  ...
  set configuration(e) {
    ...
    j(e) ? this.config = {
      ...
      holder: e
    }, Ie(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = ot.VERBOSE), _t(this.config.logLevel), Ie(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const t = {
